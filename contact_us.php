         ...
         <div class="col-sm-10">
             ...
             <div>
                 <p>It is a long established fact that a reader will be distracted by the readable content of a page
                     ...
                     distribution of letters. There are many variations of passages of Lorel Ipsum available, but the
         ...
         <div class="col-sm-3">
             <div class="contact-info">
                 ...
                 <div>
                     ...
                     <a href="http://www.facebook.com/estore" target="_blank"><img src="./img/logofb.png" alt="fb logo"
                             style="width:30px; height:30px; border:0"></a>
                     <a href="http://www.twitter.com/estore" target="_blank"><img src="./img/logotwitter.png"
                             alt="twitter logo" style="width:30px; height:30px; border:0; padding-left:10px;"></a>
                 </div>
             </div>
         </div>
     </div>
